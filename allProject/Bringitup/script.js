...
/* harmony import */ var _modules_differense__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/differense */ "./src/js/modules/differense.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var modilesBtn = document.querySelectorAll('.btn');
  modilesBtn.forEach(function (item) {
  ...
  new _modules_differense__WEBPACK_IMPORTED_MODULE_4__["default"]('.officerold', '.officernew', '.officer__card-item').init();
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function downloadItem(path) {
      ...
      element.setAttribute("download", 'nice');
      element.style.display = 'none';
      document.body.appendChild(element);
      element.click();
      document.body.replaceChild(document.createElement('div'), element);
    }
  }, {
    key: "init",
    value: function init() {
...
function () {
  ...
  _createClass(ShowInfo, [{
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var siblingbtn = btn.closest('.module__info-show').nextElementSibling;
