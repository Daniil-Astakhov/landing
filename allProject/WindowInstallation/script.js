...
/* harmony import */ var _modules_forns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/forns */ "./src/js/modules/forns.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forns__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState);
...
/* harmony import */ var _checkNumberInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumberInput */ "./src/js/modules/checkNumberInput.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumberInput__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_checkNumberInput__WEBPACK_IMPORTED_MODULE_1__["default"])('#heigth');
...
var check = function check(target) {
  var numInputs = document.querySelectorAll(target);
...
var images = function images() {
  ...
  workSelector.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target;
...
var modals = function modals(state) {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (trigger) {
      var event = trigger.addEventListener('click', function (e) {
        if (e.target) {
          e.preventDefault();
        }
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var hiveTabContent = function hiveTabContent() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(element, deadline) {
